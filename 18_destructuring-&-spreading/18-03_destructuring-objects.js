...
const getInfo = (obj) => {
  return `My name is ${obj.firstname} ${obj.lastname}. I am ${obj.age} years old. My id is ${obj.id}.`;
};
console.log(getInfo(info));

const getInfo2 = ({ firstname, lastname, age, id }) => {
  return `My name is ${firstname} ${lastname}. I am ${age} years old. My id is ${id}.`;
};
