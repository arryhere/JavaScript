...
function func1(outer_var){                                          // func 1 execute first
    return function func2(inner_var){                               // func2 is returned by func1 then func2 is executed, func2 keeps the outer_var
